...
const seedDatabase = async () => {
    try {
        ...
        const files = [
            'tmp_anthro_malayalam_part1.json',
            'tmp_anthro_malayalam_part2.json',
            'tmp_anthro_malayalam_part3.json',
            'tmp_anthro_malayalam_part4.json'
        ];
        ...
        let lastChapter = "General Anthropology";
        ...
        for (let i = 0; i < uniquePayloads.length; i++) {
            ...
            let chapterName = q.chapter; // e.g., "നരവംശശാസ്ത്ര ഗവേഷണരീതികളും സങ്കേതങ്ങളും (Anthropological Research Methods and Techniques)"
            
            if (!questionText) {
                questionText = q.chapter; // fallback if malformed
            ...
            questionsToInsert.push({
                ...
                medium: 'Malayalam',
                difficulty: 'Medium',
                chapterName: chapterName || "General Anthropology",
