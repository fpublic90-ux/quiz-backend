...
const seedDatabase = async () => {
    try {
        ...
        const files = [
            'tmp_ecomacro_malayalam_part1.json',
            'tmp_ecomacro_malayalam_part2.json',
            'tmp_ecomacro_malayalam_part3.json',
            'tmp_ecomacro_malayalam_part4.json'
        ];
        ...
        let lastChapter = "General Economics Macro";
        ...
        for (let i = 0; i < uniquePayloads.length; i++) {
            ...
            questionsToInsert.push({
                ...
                subject: 'Economics (Introductory Macroeconomics)',
                class: '+2',
                medium: 'Malayalam',
                difficulty: 'Medium',
                chapterName: chapterName || "General Economics Macro",
