...
const seedDatabase = async () => {
    try {
        ...
        const files = [
            'tmp_bio_malayalam_part1.json',
            'tmp_bio_malayalam_part2.json',
            'tmp_bio_malayalam_part3.json',
            'tmp_bio_malayalam_part4.json'
        ];
        ...
        let lastChapter = "General Biology";
        ...
        for (let i = 0; i < uniquePayloads.length; i++) {
            ...
            questionsToInsert.push({
                ...
                medium: 'Malayalam',
                difficulty: 'Medium',
                chapterName: chapterName || "General Biology",
