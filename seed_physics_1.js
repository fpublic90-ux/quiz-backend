...
const seedDatabase = async () => {
    try {
        ...
        const files = [
            'tmp_p1_english_part1.json',
            'tmp_p1_english_part2.json',
            'tmp_p1_english_part3.json',
            'tmp_p1_english_part4.json'
        ];
        ...
        let lastChapter = "General Physics 1";
        ...
        for (let i = 0; i < uniquePayloads.length; i++) {
            ...
            let chapterName = q.chapter || lastChapter;
            
            if (!questionText) {
                questionText = chapterName;
            } else if (q.chapter) {
