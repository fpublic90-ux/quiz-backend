...
const seedDatabase = async () => {
    try {
        ...
        const files = [
            'tmp_bs_2_malayalam_part1.json',
            'tmp_bs_2_malayalam_part2.json',
            'tmp_bs_2_malayalam_part3.json',
            'tmp_bs_2_malayalam_part4.json'
        ];
        ...
        let lastChapter = "General Business Studies 2";
        ...
        for (let i = 0; i < uniquePayloads.length; i++) {
            ...
            questionsToInsert.push({
                ...
                medium: 'Malayalam',
                difficulty: 'Medium',
                chapterName: chapterName || "General Business Studies 2",
